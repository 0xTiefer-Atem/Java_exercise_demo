...
import com.imooc.netty.websocket.dao.MyClientChannel;
import com.imooc.netty.websocket.dao.MyServerChannel;
...
public class ChannelManage {
    ...
    //客户的channel列表
    private static ConcurrentHashMap<String, MyClientChannel> clientAndChannelMap = new ConcurrentHashMap<>();

    //客服的channel列表
    private static ConcurrentHashMap<String, MyServerChannel> serverAndChannelMap = new ConcurrentHashMap<>();
    ...
    public static ConcurrentHashMap<String, MyClientChannel> getClientAndChannelMap() {
        return clientAndChannelMap;
    }

    public static ConcurrentHashMap<String, MyServerChannel> getServerAndChannelMap() {
        return serverAndChannelMap;
    }
